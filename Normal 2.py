...
# Buttons
btn1 = Button(frame0, text="Login/Register", bg='white', fg='black', border=0, highlightthickness=0, command=login)
btn1.place(relx=0.38, rely=0.2, relwidth=0.35, relheight=0.11)
btn2 = Button(frame0, text="Select Book", bg='white', fg='black', border=0, highlightthickness=0)
btn2.place(relx=0.38, rely=0.35, relwidth=0.35, relheight=0.11)
btn3 = Button(frame0, text="Return Book", bg='white', fg='black', border=0, highlightthickness=0)
btn3.place(relx=0.38, rely=0.50, relwidth=0.35, relheight=0.11)
btn4 = Button(frame0, text="Exit", bg='white', fg='black', command=root0.destroy, border=0, highlightthickness=0)
