...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def Entry_page(self):
        ...
        # Buttons
        btn1 = Button(frame0, text="Login/Register", bg='orange', fg='black', border=0,font=('Popins', 10),command=self.signin_1)
        btn1.place(relx=0.34, rely=0.2, relwidth=0.40, relheight=0.10)
        btn3 = Button(frame0, text="Add Book", bg='orange', fg='#000', border=0,font=('Popins', 10),command=self.log_check3)
        btn3.place(relx=0.34, rely=0.36, relwidth=0.40, relheight=0.10)
        btn2 = Button(frame0, text="Select Book", bg='orange', fg='#000', border=0,font=('Popins', 10),command=self.log_check1)
        btn2.place(relx=0.34, rely=0.52, relwidth=0.40, relheight=0.10)
        btn3 = Button(frame0, text="Return Book", bg='orange', fg='#000', border=0,font=('Popins', 10),command=self.log_check2)
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def login(self):
            ...
            def check():
                ...
                if username1=='' or passingword=='' or username1=='Username' or passingword=='Password':
                    ...
                    try:
                        ...
                        return
                    query=f'select *from userdata where username={username.get()} and createpassword={Password.get()}'
            ...
            username = Entry(frame, width=25, fg='black', bg='white', highlightthickness=0, border=0, font=('Popins', 11, 'italic'))
           ...
           # on_leave function
            ...
            Password = Entry(frame, width=25, fg='black', bg='white', highlightthickness=0, border=0, font=('Popins', 11, 'italic'))
            ...
            # Register button
            register = Button(frame, width=6, text='Register', bg='white', fg='blue', font=('Popins', 10), border=0, highlightthickness=0, cursor="hand2",command=self.register1)
            register.place(x=220, y=266)
            # Home Button
            Button(root1, text="Home",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page1).place(x=15, y=25)
            # Librarian login
            Button(root1, text="Librarian",width=10, pady=6, fg='black',bg='orange', border=0,command=self.lib_login).place(x=785, y=25)
            root1.mainloop()
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def  librarian_login_page(self):
        ...
        # Sign in Button
        Button(frame, text="Login",width=32, pady=6, fg='#fff',bg='blue', border=0,command=checking).place(x=55, y=217)
        # Home Button
        Button(root3, text="Home",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page6).place(x=15, y=25)
        # Student login
        Button(root3, text="Student",width=10, pady=6, fg='black',bg='orange', border=0,command=self.stu_login).place(x=785, y=25)
        root3.mainloop()
#---------------------------------------------------------------------------------------------------------------------------------------------------------  
    def register(self):
        ...
        # Register Button
        Button(frame1, text="Register", width=39, pady=6, fg='white',bg='blue', border=0,command=get_data).place(x=35, y=280)
        # Already Have an Account? label
        label=Label(frame1,text="I Have an Account?",fg="black",bg="white",font=('Popins', 9))
        label.place(x=90,y=340)
        # Sign in button
        sign_in = Button(frame1, width=6, text='Login', bg='white', fg='blue',border=0, cursor='hand2',command=self.Entry_page5)
        sign_in.place(x=200, y=340)
        # Home Button
        Button(screen1, text="Home",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page5).place(x=15, y=25)
        screen1.mainloop()
#---------------------------------------------------------------------------------------------------------------------------------------------------------    
    def add_book(self):
        global screen4
        ...
        sbmitbtn = Button(frame4,width=10, text = "Submit",font=('popins',15,'bold'),bg = "blue", fg = "white",command=self.add_bo).place(x = 200, y = 280)
        global bu1,au1,qu1
        bu1 = StringVar()
        au1 = StringVar()
        qu1 = StringVar()
        ...
        Button(screen4, text="Home",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page7).place(x=15, y=25)
        screen4.mainloop()
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def select_book(self):
        ...
        sbmitbtn = Button(frame2,width=10, text = "Submit",font=('popins',15,'bold'),bg = "blue", fg = "white",command=self.sel_bo).place(x = 200, y = 280) 
        option=[]
        try:
            global con,cursor
            con=db.connect(host="localhost",user="root",password='')
        ...
        Button(screen2, text="Home",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page2).place(x=15, y=25)
        screen2.mainloop()  
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def return_book(self):
        ...
        b_date = DateEntry(frame3,selectmode='day',date_pattern="dd-MM-yyyy",width=25,font=('popins',12),bg='#d3d3d3',textvariable=bor_date).place(x = 190, y = 200)  
        r_date = DateEntry(frame3,selectmode='day',date_pattern="dd-MM-yyyy",width=25,font=('popins',12),bg='#d3d3d3',textvariable=ret_date).place(x = 190, y = 250)
        
        sbmitbtn2 = Button(frame3,width=10, text = "Submit",font=('popins',15,'bold'),bg = "blue", fg = "white",command=self.ret).place(x = 200, y = 330)  
       
        Button(screen3, text="Home",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page3).place(x=15, y=25)
        screen3.mainloop()         
#---------------------------------------------------------------------------------------------------------------------------------------------------------        
        ...
        for j in li:
            if j[0]==bk_name:
                if j[2]==0:
                    ...
                    messagebox.showerror("Try again","Requirements exceed the limit only {} books are available".format(j[2]))
                else:
                    j[2]=j[2]-qua1
                    k=j[2]                     
                    q="update book set quantity=%s where bookname=%s"
