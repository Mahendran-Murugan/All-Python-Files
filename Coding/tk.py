...
# on_leave function
    ...
    # Register Button
        Button(frame1, text="Register", width=39, pady=6, fg='black',bg='blue', border=0,command=get_data).place(x=35, y=280)
    # Already Have an Account? label
        label=Label(frame1,text="I Have an Account?",fg="black",bg="white",font=('Popins', 9))
        label.place(x=90,y=340)
    # Sign in button
        sign_in = Button(frame1, width=6, text='Sign in', bg='white', fg='blue',border=0, cursor='hand2',command=signin)
        sign_in.place(x=200, y=340)
        screen1.mainloop()


    Password = Entry(frame, width=25, fg='black', bg='white', highlightthickness=0, border=0, show='*', font=('Popins', 11, 'italic'))
...
# Register button
    register = Button(frame, width=6, text='Register', bg='white', fg='blue', font=('Popins', 10), border=0, highlightthickness=0, cursor="hand2",command=register)
